...
class _MainPageState extends State<MainPage> {
  ...
  Future<List<JobsModel>> getLiveMatches() async {
    http.Response response = await http.get(Uri.parse(
        "https://serpapi.com/search.json?engine=google_jobs&q=appdevelopment&hl=en&api_key=5192aaf9e03bcbc1dd8e06aa712c2812d074dbca15d212be9a75323f9663fa4c"));
  ...
  Future<List<JobsModel>> getRecentJobs() async {
    http.Response response = await http.get(Uri.parse(
        "https://serpapi.com/search.json?engine=google_jobs&q=flutter&hl=en&api_key=5192aaf9e03bcbc1dd8e06aa712c2812d074dbca15d212be9a75323f9663fa4c"));
    var parseData = json.decode(response.body);
    var jsonArray = parseData['jobs_results'];
    List<JobsModel> jobs = [];
    for (var jsonJob in jsonArray) {
