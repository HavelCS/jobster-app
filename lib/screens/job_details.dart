// ignore_for_file: prefer_const_constructors, avoid_unnecessary_containers, sized_box_for_whitespace, prefer_const_literals_to_create_immutables, non_constant_identifier_names, prefer_typing_uninitialized_variables
...
class _JobDetailsState extends State<JobDetails> {
  ...
  Future getJobs() async {
    http.Response response = await http.get(Uri.parse(
        "https://serpapi.com/search.json?engine=google_jobs&q=${widget.job_id}&hl=en&api_key=d294b38718bdc1427e6d734e84ec7f428e5623f15d3439ab6edb2d19599be5c3"));
    var parseData = json.decode(response.body);
    var jsonArray = parseData['salaries'];
    url = jsonArray['link'];
  }
